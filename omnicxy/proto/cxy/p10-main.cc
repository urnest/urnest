...
#include <omnicxy/proto/p10.hh>
#include <omnicxy/proto/p10.cref.hh>
#include <omnicxy/proto/p10.sref.hh>
...
int main(int argc, char* argv[])
{
  try {
    ...
    if (argv[2]==std::string("client")) {
      ...
      cxy::cref<p10::F> ref(orb, makeURI(port, OBJECT_NAME));
      ref->f1(::p10::EN::BB);
    }
      ...
      cxy::sref<p10::F> const xa(orb, OBJECT_NAME, x);
    ...
    else
    {
      ...
      xju::assert_equal(x.calls_.size(),1U);
      {
        ...
        xju::assert_equal(c, F_impl::Call::f1(::p10::EN::BB));
      }
    }
    return 0;
  }
