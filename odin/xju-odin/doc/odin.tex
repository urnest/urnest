...
With the {\ex VerifyLevel} variable set to {\ex 1} Odin will use Linux inotify
to track changes.
With the {\ex VerifyLevel} variable set to {\ex 2} Odin expects all source file changes
to be explicitly indicated via the  {\ex filename!:test} odin-command,
