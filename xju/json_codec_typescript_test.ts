...
namespace xju {
    export namespace json_codec {
        ...
        export type TypeScriptFQN = xju.json_codec.TypeScriptUQN[];
        export function asInstanceOfTypeScriptFQN(v:any): xju.json_codec.TypeScriptFQN
        {
            _asInstanceOfTypeScriptFQN.f(v).applyDefaults();
            return v as xju.json_codec.TypeScriptFQN;
        }
        
        export function isInstanceOfTypeScriptFQN(v:any): v is xju.json_codec.TypeScriptFQN
        {
            const r:false|xju.json_codec.ApplyDefaults=_isInstanceOfTypeScriptFQN(v);
            return r && r.applyDefaults();
        }
        
        export const _asInstanceOfTypeScriptFQN = xju.json_codec.asInstanceOfTuple([
            xju.json_codec._asInstanceOfTypeScriptUQN
        ]);
        
        export const _isInstanceOfTypeScriptFQN = xju.json_codec.isInstanceOfTuple([
            xju.json_codec._isInstanceOfTypeScriptUQN
        ]);
        
        export type TypeScriptNamespaceFQN = xju.json_codec.TypeScriptFQN;
        export function asInstanceOfTypeScriptNamespaceFQN(v:any): xju.json_codec.TypeScriptNamespaceFQN
        {
            _asInstanceOfTypeScriptNamespaceFQN.f(v).applyDefaults();
            return v as xju.json_codec.TypeScriptNamespaceFQN;
        }
        
        export function isInstanceOfTypeScriptNamespaceFQN(v:any): v is xju.json_codec.TypeScriptNamespaceFQN
        {
            const r:false|xju.json_codec.ApplyDefaults=_isInstanceOfTypeScriptNamespaceFQN(v);
            return r && r.applyDefaults();
        }
        
        export const _asInstanceOfTypeScriptNamespaceFQN = xju.json_codec._asInstanceOfTypeScriptFQN;
        
        export const _isInstanceOfTypeScriptNamespaceFQN = xju.json_codec._isInstanceOfTypeScriptFQN;
        ...
        export type TypeScriptNamespace = {
            ...
            namespaces_this_namespace_depends_on: Array<xju.json_codec.TypeScriptNamespaceFQN>;
        };
        ...
        export const _asInstanceOfTypeScriptNamespace = xju.json_codec.asInstanceOfClass('xju.json_codec.TypeScriptNamespace', [
            ...
            {propertyName: 'namespaces_this_namespace_depends_on', asInstance: xju.json_codec.asInstanceOfList(xju.json_codec._asInstanceOfTypeScriptNamespaceFQN), defaultValue: []}
        ]);
        ...
        export const _isInstanceOfTypeScriptNamespace = xju.json_codec.isInstanceOfClass('xju.json_codec.TypeScriptNamespace', [
            ...
            {propertyName:'namespaces_this_namespace_depends_on', isInstance:xju.json_codec.isInstanceOfList(xju.json_codec._isInstanceOfTypeScriptNamespaceFQN), defaultValue: []}
        ]);
    }
}
namespace xju {
