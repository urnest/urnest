...
// implied warranty.
//
#ifndef XJU_SNMP_GAUGE32VALUE_H
#define XJU_SNMP_GAUGE32VALUE_H
...
class Gauge32Value : public Value
{
public:
  explicit Gauge32Value(uint32_t val) throw();
  uint32_t val_;
  ...
  // Value::
  // pre: y is a Gauge32Value
  virtual bool less(Value const& y) const throw() override;

  friend bool operator<(Gauge32Value const& x, Gauge32Value const& y) throw()
  {
