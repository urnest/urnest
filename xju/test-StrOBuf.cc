...
void test1() {
  {
    ...
    auto e=std::copy(four.begin(),four.end(),space.first);
    space=x.flush(e-space.first);
    ...
    *e++=',';
    ...
    e=std::copy(five.begin(),five.end(),space.first);
    xju::assert_equal(e,space.second);
    space=x.flush(e-space.first);
    ...
    e=std::copy(seven.begin(),seven.end(),space.first);
    space=x.flush(e-space.first);
