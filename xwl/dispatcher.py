...
from xwl.wsgi import getVariablesFromWSGIenviron, getCookiesFromWSGIenviron, getHTTPHeadersFromWSGIenviron
from typing import Set,Callable,Dict,Union,Tuple,List
from xwl import public_functions, restricted_functions,ClientError,Forbidden,NotFound,Response,promoteContent
    ...
    def dispatchToFunction(self,name,environ,start_response,mod):
        ...
        try:
            ...
            if not f in public_functions and not f in restricted_functions:
                raise Forbidden('%(fname)s is not annotated with @xwl.public (or @public) or @xwl.restricted (or @restricted)'%vars())
            result=None
